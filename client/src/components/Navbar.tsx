...
import { Menu, X, Download, Send, Globe, MessageSquare, Briefcase } from "lucide-react";
          ...
          <div className="hidden lg:flex items-center gap-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem>
                  <Link href="/aa-whatsapp" className="flex items-center gap-2 w-full text-primary">
