      ...
      <main className="pt-32 pb-20 overflow-hidden">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            >
              ...
              <h1 className="text-5xl md:text-7xl font-black font-display tracking-tight leading-[1.1]">
                About <span className="text-primary text-glow">AA WhatsApp</span>
              </h1>
              <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed font-medium">
                AA WhatsApp is a powerful modified version of the official WhatsApp designed for users who want more features, enhanced privacy, and customization options. 
              </p>
              <p className="text-lg text-muted-foreground/80 leading-relaxed">
                Unlike the official app, AA WhatsApp provides unlimited media sharing, advanced privacy controls, and personalized themes, making it one of the most popular WhatsApp mods in 2026. Whether you want to hide your online status, protect chats, or send large files without limits, AA WhatsApp has you covered.
              </p>
              <div className="flex gap-4 pt-4">
                <Link href="/download">
                  <Button size="lg" className="rounded-2xl px-8 h-16 text-xl font-bold shadow-lg shadow-primary/20">
            ...
            >
              <img src={heroImage} alt="About AA WhatsApp" className="rounded-[3rem] shadow-2xl border border-white/10" />
        ...
        <section className="bg-secondary/10 py-24 relative overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16 space-y-4">
              <h2 className="text-4xl md:text-6xl font-black tracking-tight">Why Choose <span className="text-primary">AA WhatsApp?</span></h2>
              <p className="text-muted-foreground text-xl max-w-2xl mx-auto">Choosing AA WhatsApp over the official WhatsApp or other mods comes with many advantages.</p>
            </div>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-black mb-4 tracking-tight">AA WhatsApp vs <span className="text-primary">Official</span></h2>
              <p className="text-muted-foreground text-lg">While the official WhatsApp is reliable, it has limitations that AA WhatsApp solves.</p>
            </div>
              ...
              <Table>
                <TableHeader className="bg-secondary/50">
                  <TableRow className="border-white/10">
                    <TableHead className="py-6 px-8 text-xl font-bold">Feature</TableHead>
                    <TableHead className="py-6 px-8 text-xl font-bold text-center">AA WhatsApp</TableHead>
                    <TableHead className="py-6 px-8 text-xl font-bold text-center">Official WhatsApp</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {[
                    { f: "Privacy Controls", aa: true, off: false, label: "Advanced" },
                    { f: "Media Sharing", aa: true, off: false, label: "Unlimited" },
                    { f: "Themes & Customization", aa: true, off: false, label: "Yes" },
                    { f: "Anti-Delete Messages", aa: true, off: false, label: "Yes" },
                    { f: "In-App Lock", aa: true, off: false, label: "Yes" },
                  ].map((row, i) => (
                    <TableRow key={i} className="border-white/5 hover:bg-white/[0.02] transition-colors">
                      <TableCell className="py-6 px-8 font-bold text-lg">{row.f}</TableCell>
                      <TableCell className="py-6 px-8 text-center">
                        <div className="flex flex-col items-center gap-1">
                          <CheckCircle2 className="w-7 h-7 text-primary" />
                          <span className="text-xs font-black text-primary uppercase">{row.label}</span>
                        </div>
                      </TableCell>
                      <TableCell className="py-6 px-8 text-center opacity-40">
                        <div className="flex flex-col items-center gap-1">
                          <XCircle className="w-7 h-7 text-muted-foreground" />
                          <span className="text-xs font-black uppercase">Limited/No</span>
                        </div>
                      </TableCell>
                    </TableRow>
                  ))}
          ...
          <div className="container mx-auto px-4">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <motion.div 
                ...
                className="space-y-8"
              >
                <h2 className="text-4xl md:text-6xl font-black tracking-tight">Safety of <span className="text-primary text-glow">AA WhatsApp</span></h2>
                <div className="space-y-6">
                  <p className="text-xl text-muted-foreground leading-relaxed">
                    AA WhatsApp is safe when downloaded from trusted websites and when you avoid third-party cracked APKs. 
                  </p>
                  <div className="grid gap-4">
                    {[
                      ...
                      <div key={i} className="flex items-center gap-4 p-4 rounded-2xl bg-background/40 border border-white/5">
                  ...
                  <div className="p-6 rounded-2xl bg-primary/10 border border-primary/20 text-primary font-bold">
                    Pro Tip: Always backup your chats before installing or updating AA WhatsApp.
                  </div>
                </div>
              </motion.div>
              <motion.div 
                ...
                className="relative"
              >
                <img src={privacyImage} alt="AA WhatsApp Safety" className="rounded-[3rem] shadow-2xl border border-white/10" />
              </motion.div>
            </div>
          </div>
        </section>
        ...
        <section className="py-24">
          <div className="container mx-auto px-4 text-center max-w-3xl">
            <h2 className="text-4xl md:text-5xl font-black mb-12 tracking-tight">Who Should Use <span className="text-primary">AA WhatsApp?</span></h2>
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                { t: "Privacy Seekers", d: "Want more control than official app.", i: Lock },
                { t: "Style Enthusiasts", d: "Love to customize themes & UI.", i: Palette },
                { t: "Media Heavy Users", d: "Need to send large files & 100+ images.", i: Zap },
                { t: "Safety First Users", d: "Want anti-ban mod with security.", i: ShieldCheck },
              ].map((item, i) => (
                <div key={i} className="p-8 rounded-[2rem] bg-secondary/20 border border-white/5 flex flex-col items-center">
          ...
          <div className="glass-card rounded-[4rem] p-12 md:p-20 text-center border border-primary/30 relative overflow-hidden bg-gradient-to-br from-primary/20 via-background to-emerald-900/20">
            <div className="relative z-10 max-w-3xl mx-auto space-y-10">
              <h2 className="text-4xl md:text-7xl font-black font-display tracking-tight leading-none">
                Get the <span className="text-primary text-glow">Latest Version</span> 2026
              </h2>
              <p className="text-xl md:text-2xl text-muted-foreground font-medium">
                Stay updated for bug fixes, security patches, and the fastest performance.
              </p>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <Link href="/download" className="w-full sm:w-auto">
                  <button className="px-12 py-6 rounded-3xl bg-primary text-primary-foreground font-black text-2xl shadow-[0_0_30px_rgba(16,185,129,0.3)] hover:shadow-[0_0_60px_rgba(16,185,129,0.5)] hover:-translate-y-1 transition-all w-full flex items-center justify-center gap-4 group">
                    Download Now <ArrowRight className="group-hover:translate-x-2 transition-transform w-8 h-8" />
                  </button>
                </Link>
